    ...
    class GameOnTrack
    {
        ...
        private static void OnMeasurementReceived(Measurement measurement)
        {
            ...
            else
            {
                ...
                {
                    if( pos.TxAddress.ToString() == MainWindow.sensor1.address.ToString() )
                    {
                        MainWindow.sensor1.x = pos.Position.X;
                        MainWindow.sensor1.y = pos.Position.Y;
                        MainWindow.sensor1.z = pos.Position.Z;
                    }
                    if (pos.TxAddress.ToString() == MainWindow.sensor2.address.ToString())
                    {
                        MainWindow.sensor2.x = pos.Position.X;
                        MainWindow.sensor2.y = pos.Position.Y;
                        MainWindow.sensor2.z = pos.Position.Z;
                    }
                }
                else
                {
